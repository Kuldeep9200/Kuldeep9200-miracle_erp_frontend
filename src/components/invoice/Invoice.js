...
// import CreatAdmissionFrom from "./CreatAdmissionFrom";
     ...
     {isLoading ? (
      ...
      <div className="maincontainer">
        <div className="card">
          <div className="card-body erpbody">
            ...
            <h6 className="admissionf1">
              {" "}
            <NavLink to="/dashboard">Home</NavLink> <KeyboardDoubleArrowRightOutlinedIcon /> Invoice{" "}
            </h6>
          </div>
        </div>
        ...
        <div className="card mt-3 mb-3 buttoncard">
          <div className=" cardbuttonnew" style={{margin:"10px"}}>
            <NavLink to="/invoicefrom">
              <button className="createnew"> Make Payment</button>
            </NavLink>
          </div>
          <InvoiceData />
        </div>
